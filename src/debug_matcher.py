...
from shtest_compiler.compiler.matchers.basic_checks_matcher import load_patterns, strip_accents
...
def debug_matcher():
    ...
    if fp_pattern:
        ...
        normalized_aliases = [strip_accents(alias.lower()) for alias in aliases if not alias.startswith('^')]
